    ...
    return (
        <div
            className={`min-h-screen flex items-center justify-center p-4
              ${mode === "register" && "bg-neo-pink"}
              ${mode === "login" && "bg-neo-cyan"}
              ${mode === "reset" && "bg-black"}
            `}
        >
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-6">
                    <h1 className="font-mono font-bold text-3xl text-neo-white tracking-wider">
                        HYBRID WALLET
                    </h1>
                    <p
                    ...
                    >
                        {mode === "register" && "JOIN THE REVOLUTION"}
                        {mode === "login" && "SECURE • FAST • BRUTAL"}
                ...
                <div className="bg-neo-white border-4 border-neo-black shadow-brutal p-6">
                    ...
                    {mode === "reset" && (
                        <p className="font-mono font-bold text-sm text-neo-black text-center mb-6">
                ...
                {mode === "reset" && (
                    <div className="mt-6">
                        <button
                            type="button"
                            onClick={() => setMode("login")}
                            className="w-full flex items-center justify-center gap-2 py-3 bg-neo-cyan text-neo-black font-mono font-bold border-4 border-neo-black shadow-brutal hover:shadow-brutal-lg transition-shadow"
                        >
