...
exports.adminValidators = {
    ...
    updateAdmin: [
        (0, express_validator_1.param)("adminId").isMongoId().withMessage("Valid admin ID is required"),
        (0, express_validator_1.body)("firstName")
            .optional()
            .isLength({ min: 1, max: 50 })
            .withMessage("First name must be between 1 and 50 characters"),
    ...
    getCard: [
        (0, express_validator_1.param)("cardId").isUUID().withMessage("Valid card UUID is required"),
    ],
    updateCardStatus: [
        (0, express_validator_1.param)("cardId").isUUID().withMessage("Valid card UUID is required"),
        (0, express_validator_1.body)("status")
    ...
    blockCard: [
        (0, express_validator_1.param)("cardId").isUUID().withMessage("Valid card UUID is required"),
        (0, express_validator_1.body)("reason").notEmpty().withMessage("Block reason is required"),
    ],
    unblockCard: [
        (0, express_validator_1.param)("cardId").isUUID().withMessage("Valid card UUID is required"),
    ],
    ...
    getKYCRequest: [
        (0, express_validator_1.param)("kycId").isMongoId().withMessage("Valid KYC ID is required"),
    ],
    approveKYC: [
        (0, express_validator_1.param)("kycId").isMongoId().withMessage("Valid KYC ID is required"),
    ],
    ...
    getAuditLog: [
        (0, express_validator_1.param)("logId").isMongoId().withMessage("Valid log ID is required"),
    ],
    clearCache: [
