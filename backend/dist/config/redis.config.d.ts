...
export declare const getCached: (key: string) => Promise<any>;
export declare const setCached: (key: string, data: any, ttl?: number) => Promise<boolean>;
export declare const deleteCached: (key: string) => Promise<boolean>;
export declare const setCachedBatch: (items: Array<{
    key: string;
    data: any;
    ttl?: number;
}>) => Promise<boolean>;
export declare const getCachedBatch: (keys: string[]) => Promise<{
    [key: string]: any;
}>;
export declare const cacheWithFallback: <T>(key: string, fallbackFn: () => Promise<T>, ttl?: number) => Promise<T>;
export declare const NFCCacheKeys: {
    cardStatus: (cardUuid: string) => string;
    cardLimits: (cardUuid: string) => string;
    dailySpending: (cardUuid: string, date: string) => string;
    userWallet: (userId: string) => string;
    fastValidation: (cardUuid: string, amount: number) => string;
    fraudScore: (cardUuid: string, terminalId: string) => string;
    terminalStatus: (terminalId: string) => string;
    merchantInfo: (merchantId: string) => string;
};
export declare const getRedisStats: () => Promise<{
    connected: boolean;
    info: string;
    timestamp: Date;
    latency: number;
