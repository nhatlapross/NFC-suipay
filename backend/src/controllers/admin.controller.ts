...
export class AdminController {
    ...
    async getSystemHealth(
        ...
        try {
            ...
            const successRate =
                (healthMetrics.transactionMetrics[0]?.successful /
    ...
    async getDashboard(
        ...
        try {
            logger.info("Admin accessing payment dashboard", {
    ...
    async getMerchants(
        ...
        try {
            const merchantHealth =
                await adminService.getMerchantPaymentHealth();
    ...
    async getMerchant(
        ...
        try {
            ...
            const merchantHealth =
                await adminService.getMerchantPaymentHealth(merchantId);
    ...
    async getTransaction(
        ...
        try {
            ...
            const transaction =
                await adminService.getTransactionById(transactionId);
    ...
    async refundTransaction(
        ...
        try {
            ...
            const result = await adminService.forceRefundTransaction(
                transactionId,
                reason,
                adminId
            );
    ...
    async updateCardStatus(
        ...
        try {
            ...
            if (status === "blocked") {
                const result = await adminService.blockCard(
                    cardId,
                    "Admin status change",
                    adminId
                );
